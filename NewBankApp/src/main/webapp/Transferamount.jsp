...
body {
	...
	background:
		...
		no-repeat; backdrop-filter : blur( 3px);
...
<body>
	<div class="wrapper">
		<form action="transfer" method="post">
			...
			<center>
				<%
				String fail1 = (String) session.getAttribute("fail1");
				if (fail1 != null) {
				%>
				<h4><%=fail1%></h4>
				<br>
			...
			<div class="input-box">
				<input type="tel" name="amount"
					placeholder="Enter amount to be transfer" required> <i
					class='bx bxs-user'></i>
			</div>
			<div class="input-box">
				<input type="tel" name="raccount"
					placeholder="Enter benificery account number" required> <i
